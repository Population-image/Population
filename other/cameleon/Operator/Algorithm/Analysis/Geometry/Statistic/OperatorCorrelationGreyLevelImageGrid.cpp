...
OperatorCorrelationGreyLevelMatN::OperatorCorrelationGreyLevelMatN()
    :COperator()
{
    ...
    this->setKey("PopulationOperatorCorrelationGreyLevelImageGrid");
    this->setName("correlationGreyLevel");
    this->setInformation("P(i,0)=i and P(i,1) = Proba(f(x)f(x+x')=i) with |x'|=r\n");
...
void OperatorCorrelationGreyLevelMatN::initState(){
...
void OperatorCorrelationGreyLevelMatN::exec(){
...
COperator * OperatorCorrelationGreyLevelMatN::clone(){
    return new OperatorCorrelationGreyLevelMatN();
}

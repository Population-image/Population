...
OperatorAlternateSequentialOCMatN::OperatorAlternateSequentialOCMatN()
    :COperator()
{
        this->path().push_back("Algorithm");
    this->path().push_back("Processing");
    this->path().push_back("Neighborhood");
    this->setKey("PopulationOperatorAlternateSequentialOCImageGrid");
    this->setName("alternateSequentialOC");
    this->setInformation("h(x)=Opening(Closing(...Opening(Closing(h))...)) by progessively increased the size of ball until maxRadius\n");
...
void OperatorAlternateSequentialOCMatN::initState(){
...
void OperatorAlternateSequentialOCMatN::exec(){
...
COperator * OperatorAlternateSequentialOCMatN::clone(){
    return new OperatorAlternateSequentialOCMatN();
}

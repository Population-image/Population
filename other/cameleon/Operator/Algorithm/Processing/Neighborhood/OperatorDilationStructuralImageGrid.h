#ifndef OPERATORDILATIONSTRUCTURALMatN_H
#define OPERATORDILATIONSTRUCTURALMatN_H
...
using namespace pop;
class OperatorDilationStructuralMatN : public COperator
{
public:
    OperatorDilationStructuralMatN();
    void exec();
    COperator * clone();
    struct foo
    {
    ...
    struct foo2
    {
        ...
        void operator()(MatN<DIM,Type1> * struc_elt,MatN<DIM,Type2> * in1cast, BaseMatN * &out)
        {
            ...
            *outcast = Processing::dilationStructuralElement(*in1cast,* struc_elt);
            out=outcast;
...
#endif // OPERATORDILATIONSTRUCTURALMatN_H

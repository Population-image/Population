#ifndef OPERATORCLOSINGSTRUCTURALMatN_H
#define OPERATORCLOSINGSTRUCTURALMatN_H
...
using namespace pop;
class OperatorClosingStructuralMatN : public COperator
{
public:
    OperatorClosingStructuralMatN();
    void exec();
    COperator * clone();
    struct foo
    {
    ...
    struct foo2
    {
        ...
        void operator()(MatN<DIM,Type1> * struc_elt,MatN<DIM,Type2> * in1cast, BaseMatN * &out)
        {
            ...
            *outcast = Processing::closingStructuralElement(*in1cast,* struc_elt);
            out=outcast;
...
#endif // OPERATORCLOSINGSTRUCTURALMatN_H

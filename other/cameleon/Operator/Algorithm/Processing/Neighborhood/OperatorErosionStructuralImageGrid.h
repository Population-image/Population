#ifndef OPERATORErosionStructuralSTRUCTURALMatN_H
#define OPERATORErosionStructuralSTRUCTURALMatN_H
...
using namespace pop;
class OperatorErosionStructuralMatN : public COperator
{
public:
    OperatorErosionStructuralMatN();
    void exec();
    COperator * clone();
    struct foo
    {
    ...
    struct foo2
    {
        ...
        void operator()(MatN<DIM,Type1> * struc_elt,MatN<DIM,Type2> * in1cast, BaseMatN * &out)
        {
            ...
            *outcast = Processing::erosionStructuralElement(*in1cast,* struc_elt);
            out=outcast;
...
#endif // OPERATORErosionStructuralSTRUCTURALMatN_H

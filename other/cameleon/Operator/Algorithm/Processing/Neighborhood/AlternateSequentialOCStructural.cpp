...
OperatorAlternateSequentialOCStructuralMatN::OperatorAlternateSequentialOCStructuralMatN()
    :COperator()
{
        this->path().push_back("Algorithm");
    this->path().push_back("Processing");
    this->path().push_back("Neighborhood");
    this->setKey("PopulationOperatorAlternateSequentialOCStructuralImageGrid");
    this->setName("alternateSequentialOCStructuralElement");
...
void OperatorAlternateSequentialOCStructuralMatN::exec(){
...
COperator * OperatorAlternateSequentialOCStructuralMatN::clone(){
    return new OperatorAlternateSequentialOCStructuralMatN();
}

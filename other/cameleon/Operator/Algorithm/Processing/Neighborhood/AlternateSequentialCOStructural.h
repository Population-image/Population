#ifndef OPERATORALTERNATESEQUENTIALCOSTRUCTURALMatN_H
#define OPERATORALTERNATESEQUENTIALCOSTRUCTURALMatN_H
...
using namespace pop;
class OperatorAlternateSequentialCOStructuralMatN : public COperator
{
public:
    OperatorAlternateSequentialCOStructuralMatN();
    void exec();
    COperator * clone();
    ...
    struct foo2
    {
        ...
        void operator()(MatN<DIM,Type1> * struc_elt,MatN<DIM,Type2> * in1cast,int max_radius, BaseMatN * &out)
        {
            ...
            *outcast = Processing::alternateSequentialCOStructuralElement(*in1cast,max_radius,* struc_elt);
            out=outcast;
...
#endif // OPERATORALTERNATESEQUENTIALCOSTRUCTURALMatN_H

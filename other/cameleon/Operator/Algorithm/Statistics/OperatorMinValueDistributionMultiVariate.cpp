...
OperatorMinValueDistributionMultiVariate::OperatorMinValueDistributionMultiVariate()
    :COperator()
{
        this->path().push_back("Algorithm");
    this->path().push_back("Statistics");
            this->path().push_back("DistributionMultiVariate");
    this->setKey("PopulationOperatorMinValueDistributionMultiVariate");
...
void OperatorMinValueDistributionMultiVariate::initState(){
...
void OperatorMinValueDistributionMultiVariate::exec(){
    ...
    pop::F64 value =  Statistics::minValue( f, xmin, xmax, step);
    dynamic_cast<DataNumber *>(this->plugOut()[0]->getData())->setValue(value);
}

COperator * OperatorMinValueDistributionMultiVariate::clone(){
    return new OperatorMinValueDistributionMultiVariate();
}

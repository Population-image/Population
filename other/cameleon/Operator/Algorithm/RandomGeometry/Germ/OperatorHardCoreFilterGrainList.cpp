...
using namespace pop;
OperatorHardCoreGermGrain::OperatorHardCoreGermGrain()
    :COperator()
{
    this->path().push_back("Algorithm");
    this->path().push_back("RandomGeometry");
    this->path().push_back("Germ");
    this->setKey("OperatorHardCoreGrainList");
    this->setName("hardCoreFilter");
...
void OperatorHardCoreGermGrain::exec(){
...
COperator * OperatorHardCoreGermGrain::clone(){
    return new OperatorHardCoreGermGrain;
}

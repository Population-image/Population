...
OperatorDivScalarMatN::OperatorDivScalarMatN()
    :COperator()
{
    ...
    this->setKey("PopulationOperatorDivScalarImageGrid");
    this->setName("divisionScalar");
...
void OperatorDivScalarMatN::exec(){
...
COperator * OperatorDivScalarMatN::clone(){
    return new OperatorDivScalarMatN();
}

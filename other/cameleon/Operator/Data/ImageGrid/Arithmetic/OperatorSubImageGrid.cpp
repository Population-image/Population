...
OperatorSubMatN::OperatorSubMatN()
    :COperator()
{
    ...
    this->setKey("PopulationOperatorSubImageGrid");
...
COperator * OperatorSubMatN::clone(){
    return new OperatorSubMatN();
}

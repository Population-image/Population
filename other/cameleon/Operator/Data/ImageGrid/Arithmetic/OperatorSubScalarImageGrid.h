#ifndef OPERATORSUBSCALARMatN_H
#define OPERATORSUBSCALARMatN_H

#include"COperator.h"
#include"data/mat/MatN.h"
#include"algorithm/Processing.h"
using namespace pop;
class OperatorSubScalarMatN : public COperator
{
public:
    OperatorSubScalarMatN();
    void exec();
    COperator * clone();
    struct foo
    {

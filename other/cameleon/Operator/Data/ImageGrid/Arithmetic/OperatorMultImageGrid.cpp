...
OperatorMultMatN::OperatorMultMatN()
    :COperator()
{
    ...
    this->setKey("PopulationOperatorMultImageGrid");
    this->setName("multiplicationTermByTerm");
    this->setInformation("h=f1*f2\n");
...
COperator * OperatorMultMatN::clone(){
    return new OperatorMultMatN();
}

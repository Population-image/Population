...
OperatorAddMatN::OperatorAddMatN()
    :COperator()
{
    ...
    this->setKey("PopulationOperatorAddImageGrid");
...
COperator * OperatorAddMatN::clone(){
    return new OperatorAddMatN();
}

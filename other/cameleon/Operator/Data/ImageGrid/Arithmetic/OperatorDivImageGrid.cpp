...
OperatorDivMatN::OperatorDivMatN()
    :COperator()
{
    ...
    this->setKey("PopulationOperatorDivImageGrid");
...
COperator * OperatorDivMatN::clone(){
    return new OperatorDivMatN();
}

...
OperatorMaxMatN::OperatorMaxMatN()
    :COperator()
{
    ...
    this->setKey("PopulationOperatorMaxImageGrid");
    this->setName("maximum");
    this->setInformation("h=max(f1,f2)\n");
...
COperator * OperatorMaxMatN::clone(){
    return new OperatorMaxMatN();
}

...
OperatorAddScalarMatN::OperatorAddScalarMatN()
    :COperator()
{
    ...
    this->setKey("PopulationOperatorAddScalarImageGrid");
...
void OperatorAddScalarMatN::exec(){
...
COperator * OperatorAddScalarMatN::clone(){
    return new OperatorAddScalarMatN();
}

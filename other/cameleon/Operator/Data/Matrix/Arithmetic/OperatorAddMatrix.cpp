...
OperatorAddMatrix::OperatorAddMatrix(){
    ...
    this->setKey("OperatorAddMatrix");
    this->setName("addition");
    this->setInformation("C=A+B");
}
void OperatorAddMatrix::exec(){
...
COperator * OperatorAddMatrix::clone(){
    return new OperatorAddMatrix();
}
